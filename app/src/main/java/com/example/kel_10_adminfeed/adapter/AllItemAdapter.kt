...
//(private val MenuItemName:ArrayList<String>,private val MenuItemPrice:ArrayList<String>,private val MenuItemImage:ArrayList<String>): RecyclerView.Adapter <AllItemAdapter.AddItemViewHolder>(){
//
//
